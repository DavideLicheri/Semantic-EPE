...
sshpass -p 'password' scp frontend-build.tar.gz user@<VM_IP>:/tmp/

# Estrai su server
ssh user@<VM_IP> "sudo rm -rf /opt/eces/frontend/* && sudo tar -xzf /tmp/frontend-build.tar.gz -C /opt/eces/frontend/"
